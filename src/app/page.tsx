        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-5xl text-center">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline mt-2">Unlock Your Full Potential</h2>
            ...
            <div className="mx-auto grid max-w-5xl items-start justify-center gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-2 mt-12">
              {features.map((feature, index) => (
                <Card key={index} className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 text-left">
